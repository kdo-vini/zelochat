...
**Causa-raiz:** busca ambígua entre pratos parecidos bloqueava o planner; a palavra "cardápio" numa pergunta sobre o pedido reabria o atalho do menu; extra/bebida de 3 palavras reusava a query do prato.

**Fix:** token que identifica um único prato monta o pedido; falar sobre o cardápio não pede o menu; adicional/bebida não é escolha de opção — `src/domain/aiWhatsAppOrdering.ts`, `server/aiWhatsAppOrdering.ts`. ZCHAT-AI-029.
