...
- Risco atualizado durante a auditoria: produção e simulador agora entram pelo roteador canônico antes do modelo genérico em modo restaurante; o backend foi publicado em 2026-09-01, mas a IA da Bem Servido permanece desligada até a integração autenticada do ZeloMenu passar por conversa controlada. Qualquer alteração futura deve preservar o dispatcher durável/takeover no caminho real e o `dryRun` no simulador.
