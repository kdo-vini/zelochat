...
- Risco confirmado durante a auditoria: `tryHandleAiWhatsAppOrdering` existe e tem testes, porém o fluxo textual de produção continua orientado pelo contrato “IA envia o link do ZeloMenu”; qualquer retomada do carrinho canônico dentro do WhatsApp exige reconciliar esse contrato e passar pelo dispatcher durável/takeover antes do rollout.
