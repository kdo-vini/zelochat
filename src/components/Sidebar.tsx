...
export function Sidebar({
  ...
  return (
    <aside
      className={`bg-[var(--color-surface)] border-r border-[var(--color-line)] hidden md:flex flex-col min-h-0 flex-shrink-0 z-30 transition-[width] duration-200 ease-in-out overflow-y-auto custom-scrollbar ${
