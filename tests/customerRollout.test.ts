...
const workerStore: OutboundJobStore = {
  ...
  async claim(workerId) { return { id: 'job', empresaId: 'e', instanceKey: 'i', jobType: 'campaign', campaignId: 'c', idempotencyKey: 'k', phone: '5511999999999', text: 'oi', payload: { kind: 'text', text: 'oi' }, status: 'sending', leaseOwner: workerId, attempts: 3 }; },
