...
await runSuite('navigation configuration', [
  {
    ...
    run: () => {
      const desktop = getDesktopNavigation('restaurant', { pessoas: { visualizar: true } });
      assert(
  ...
  },
  {
    ...
    run: () => {
      const mobile = getMobileNavigation('restaurant', { pessoas: { visualizar: true } });
      assert(
  ...
  },
  {
    ...
    run: () => {
      const mobile = getMobileNavigation('general', { pessoas: { visualizar: true } });
