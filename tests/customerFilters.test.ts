...
assert.deepEqual(parseCustomerFilters({ status: 'active', hasWhatsApp: 'true', vip: 'true', birthdayOnly: 'true' }), { activityState: 'active', hasPhone: true, vip: true, birthdayOnly: true });
